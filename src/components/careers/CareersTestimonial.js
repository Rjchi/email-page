const CareersTestimonial = () => {
  return (
    <div className="bg-white pt-16 lg:py-24">
      <div className="bg-purple-800 pb-16 lg:relative lg:z-10 lg:pb-0">
        <div className="lg:mx-auto lg:grid lg:max-w-6xl lg:grid-cols-3 lg:gap-8 lg:px-8">
